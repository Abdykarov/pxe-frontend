...
export const CONSTS = {
    ADULTHOOD_AGE: 18,
    COUNT_NUMBER_CONSUMPTION_THIRTEEN: 13,
    COUNT_NUMBER_CONSUMPTION_FOURTEEN: 14,
    COUNT_NUMBER_DEPOSIT: 13,
    CURRENCY: {
        DEFAULT: 'CZK',
    },
    DATE_FORMAT: {
    ...
    MAX_DIGIT: 2,
    MAX_LENGTH_BENEFIT_NAME: 100,
    MAX_LENGTH_BENEFIT_URL: 5000,
    MAX_LENGTH_CITY: 255,
    MAX_LENGTH_DIC: 12,
    MAX_LENGTH_DESCRIPTIVE_NUMBER: 16,
    MAX_LENGTH_EMAIL_SIGN_UP: 40,
    MAX_LENGTH_EMAIL_RECAPITULATION: 50,
    MAX_LENGTH_OFFER_NAME: 50,
    MAX_LENGTH_ORIENTATION_NUMBER: 16,
    MAX_LENGTH_POSITION: 80,
    MAX_LENGTH_RECAPITULATION_NAME: 150,
    MAX_LENGTH_STREET: 255,
    MAX_LENGTH_USER_PROFILE_NAME: 50,
