...
export const REGIONS = [
    ...
    {'label': 'Karlovarský kraj', 'value': 'Karlovarský kraj', 'key': '3'},
    {'label': 'Královéhradecký kraj',  'value': 'Královéhradecký kraj', 'key': '5'},
    {'label': 'Liberecký kraj', 'value': 'Liberecký kraj', 'key': '6'},
    {'label': 'Moravskoslezský kraj', 'value': 'Moravskoslezský kraj', 'key': '7'},
    {'label': 'Olomoucký kraj', 'value': 'Olomoucký kraj', 'key': '8'},
    {'label': 'Pardubický kraj', 'value': 'Pardubický kraj', 'key': '9'},
    {'label': 'Plzeňský kraj', 'value': 'Plzeňský kraj', 'key': '10'},
    {'label': 'Středočeský kraj', 'value': 'Středočeský kraj', 'key': '11'},
    {'label': 'Ústecký kraj', 'value': 'Ústecký kraj', 'key': '12'},
    {'label': 'Vysočina', 'value': 'Vysočina', 'key': '4'},
    {'label': 'Zlínský kraj', 'value': 'Zlínský kraj', 'key': '13'},
];
