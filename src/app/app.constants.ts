...
export const ROUTES = {
    ...
    ROUTER_REQUEST_OVERVIEW: `/${CONSTS.PATHS.SECURED}/${CONSTS.PATHS.REQUEST}`,
    ROUTER_REQUEST_SUPPLY_POINT_SELECTION: `/${CONSTS.PATHS.SECURED}/${CONSTS.PATHS.REQUEST}/${CONSTS.PATHS.SUPPLY_POINT_SELECTION}`,
