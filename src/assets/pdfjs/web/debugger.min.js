...
var opMap,
    FontInspector = (function () {
        var e,
            ...
            a = "data-font-name";
        function r() {
            let e = document.querySelectorAll(`span[${a}]`);
            for (let t of e) t.className = "debuggerHideText";
        }
        function i(e, t) {
            let n = document.querySelectorAll(`span[${a}=${e}]`);
            for (let e of n)
        ...
        return {
            ...
            set active(e) {
                (n = e)
                    ? (document.body.addEventListener("click", o, !0), r())
            ...
            fontAdded: function (n, a) {
                ...
                a
                    ? ((a = /url\(['"]?([^\)"']+)/.exec(a)), (p.href = a[1]))
                    : n.data && (p.href = t(n.data, n.mimeType)),
    ...
    StepperManager = (function () {
        ...
        return {
            ...
            init: function (e) {
                var i = this;
                for (var o in (this.panel.setAttribute(
                    "style",
                    "padding: 5px;"
                ),
            ...
            create: function (n) {
                ...
                (o.textContent = "Page " + (n + 1)),
                    (o.value = n),
                    a.appendChild(o);
                var d = r[n] || [],
                    l = new Stepper(i, n, d);
                return (
                    e.push(l), 1 === e.length && this.selectStepper(n, !1), l
                );
            },
        ...
        function t(e) {
            ...
            if ("length" in e) {
                var n,
                    a,
                    r = [];
                for (n = 0, a = Math.min(10, e.length); n < a; n++)
                    r.push(t(e[n]));
        ...
        return {
            ...
            add(n, a) {
                if (a) {
                    ...
                    if (!1 !== r) {
                        var i = e[r];
                        this.panel.removeChild(i.div), e.splice(r, 1);
                    }
                    var o = document.createElement("div");
                    o.className = "stats";
                    var d = document.createElement("div");
                    (d.className = "title"), (d.textContent = "Page: " + n);
                    var l = document.createElement("div");
                    (l.textContent = a.toString()),
                        o.appendChild(d),
                        o.appendChild(l),
                        e.push({ pageNumber: n, div: o }),
                        e.sort(function (e, t) {
                            return e.pageNumber - t.pageNumber;
                        }),
                        t(this.panel);
                    for (var s = 0, p = e.length; s < p; ++s)
                        this.panel.appendChild(e[s].div);
                }
            },
            cleanup() {
                (e = []), t(this.panel);
...
window.PDFBug = (function () {
    ...
    return {
        ...
        selectPanel(n) {
            if (
                ("number" != typeof n && (n = this.tools.indexOf(n)), n !== t)
            ) {
                t = n;
