    ...
    public questions: IQuestion[] = [
        {
            ...
            'shortContent': '<img class="mb-3" alt="logo - Bohemia Energy entity s.r.o." title="Bohemia Energy entity s.r.o.", width="185" src="/assets/images/suppliers/logo_bohemia-energy-hover.svg"/><p class=\'mb-0\'>První český alternativní dodavatel energií vstoupil na trh v roce 2005, elektřinu začal dodávat domácnostem v roce 2006 a o dva roky později i plyn. Dnes představuje největšího nezávislého alternativního dodavatele koncovým spotřebitelům. Bohemia Energy je aktivním účastníkem obchodování na velkoobchodním trhu, kde zajišťuje dodávky pro své zákazníky. Kromě výhodných cen energií zabezpečuje i komplexní zákaznický servis a také energetické poradenství.</p>',
            'vatNumber': '27386732',
        },
        {
            'id': 19,
        ...
        },
        {
            ...
            'shortContent': '<img class="mb-3" alt="logo - Alpiq CZ" title="Alpiq CZ", width="81" src="/assets/images/suppliers/logo_alpiq-hover.svg"/><p class=\'mb-0\'>Švýcarská energetická skupina s více než 100letou tradicí patřící mezi přední evropské energetické společnosti s působností v téměř všech zemích Evropy. Vlastní a provozuje široké portfolio energetických zdrojů a v ČR mimo jiné nabízí dodávky elektrické energie a plynu koncovým zákazníkům.</p>',
            'vatNumber': '08183929',
        },
        {
            'id': 22,
            ...
            'shortContent': '<img class="mb-3" alt="logo - Pražská plynárenská a.s." title="Pražská plynárenská a.s.", width="129" src="/assets/images/suppliers/logo_prazska-plynarenska-hover.svg"/><p class=\'mb-0\'>Jeden z nejvýznamnějších obchodníků, dodávající elektrickou energii a zemní plyn zákazníkům na celém území ČR.  Dodavatel nabízí také širokou škálu nekomoditních produktů a služeb.</p>',
            'vatNumber': '60193492',
        },
        {
            'id': 23,
        ...
        },
        {
            ...
            'seoKeywords': 'test',
            'shortContent': '<p class=\'mb-0\'>První český alternativní dodavatel energií vstoupil na trh v roce 2005, elektřinu začal dodávat domácnostem v roce 2006 a o dva roky později i plyn. Dnes představuje největšího nezávislého alternativního dodavatele koncovým spotřebitelům. Bohemia Energy je aktivním účastníkem obchodování na velkoobchodním trhu, kde zajišťuje dodávky pro své zákazníky. Kromě výhodných cen energií zabezpečuje i komplexní zákaznický servis a také energetické poradenství</p>',
            'vatNumber': '23456780',
            'isTestData': true,
        },
        {
            ...
            'seoKeywords': 'Yello Energy, férovým cenám, jednoduchost, přímočarost, náklady, kamenné pobočky, Skupiny PRE',
            'fullContent': 'Dlouhy text - Yello Energy, férovým cenám, jednoduchost, přímočarost, náklady, kamenné pobočky, Skupiny PRE',
            'shortContent': '<img class="mb-3" width="70" src="/assets/images/suppliers/logo_eon-hover.svg"/><p class=\'mb-0\'>Od roku 2012 pomáhá Yello na českém trhu desítkám tisíc klientů k férovým cenám. Jedná se o adaptaci německého konceptu Yello, který sází na jednoduchost a přímočarost. Nezatěžujeme se dlouhými řečmi ani náklady na kamenné pobočky. Náš tým je přitom snadno a stále dostupný online. Yello je součástí Skupiny PRE.</p>',
