...
export class SupplyPointImportService {
    ...
    public deleteSupplyPointImportMutation = (
        ...
        this.apollo.mutate<any>({
            ...
            update: (cache, { data }) => {
                ...
                const newState = R.reject(R.propEq('id', supplyPointImportId))(
                    findSupplyPointImports
                );
    ...
    public getSupplyPointImports = (askForOfferId: string) =>
    ...
    public mapPersonalInfoToPersonalInfoInput = (
    ...
    public mapSupplyPointToSupplyPointInput = (
        ...
        return {
            ...
            timeToContractEndPeriodId:
                supplyPoint.timeToContractEndPeriod?.code,
            ...
            ...(!!personalData && {
                personalData:
                    this.mapPersonalInfoToPersonalInfoInput(personalData),
            }),
    ...
    public mapPricesToSupplyPointImport = (
        supplyPoint: ISupplyPointImportInput,
        data: ISupplyPoint
    ): void => {
