...
export const contractEndTermWithProlongationCalculate = (supplyPointInput: ISupplyPointInput) =>
...
export const contractEndIndefinitePeriodCalculate = (supplyPointInput: ISupplyPointInput) =>
