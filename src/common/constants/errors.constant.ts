...
export const importErrorViolations = {
    ...
    'benefit1InvalidSize': 'Benefit 1 - pro název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl1InvalidSize': 'Benefit 1 - pro URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
    'benefitUrl1InvalidFormat': 'Benefit 1 vyplňte validní URL adresu',
    'benefitWithUrl1Invalid': 'Benefit 1 není validní',
    'benefit2InvalidSize': 'Benefit 2 - pro URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl2InvalidSize': 'Benefit 2 - pro název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
    'benefitUrl2InvalidFormat': 'Benefit 2 - pro vyplňte validní URL adresu',
    'benefitWithUrl2Invalid': 'Benefit 2 není validní',
    'benefit3InvalidSize': 'Benefit 3 - pro URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl3InvalidSize': 'Benefit 3 - pro název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
    'benefitUrl3InvalidFormat': 'Benefit 3 vyplňte validní URL adresu.',
    'benefitWithUrl3Invalid': 'Benefit 3 není validní',
    'benefit4InvalidSize': 'Benefit 4 - pro URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl4InvalidSize': 'Benefit 4 - pro název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
