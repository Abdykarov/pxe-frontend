...
export const importErrorViolations = {
    ...
    'benefit1InvalidSize': 'Benefit 1 název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl1InvalidSize': 'Benefit 1 URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
    'benefitUrl1InvalidFormat': 'Benefit 1 vyplňte validní URL adresu',
    'benefitWithUrl1Invalid': 'Benefit 1 není validní',
    'benefit2InvalidSize': 'Benefit 2 URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl2InvalidSize': 'Benefit 2 název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
    'benefitUrl2InvalidFormat': 'Benefit 2 vyplňte validní URL adresu',
    'benefitWithUrl2Invalid': 'Benefit 2 není validní',
    'benefit3InvalidSize': 'Benefit 3 URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl3InvalidSize': 'Benefit 3 název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
    'benefitUrl3InvalidFormat': 'Benefit 3 vyplňte validní URL adresu.',
    'benefitWithUrl3Invalid': 'Benefit 3 není validní',
    'benefit4InvalidSize': 'Benefit 4 URL použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_URL + ' znaků',
    'benefitUrl4InvalidSize': 'Benefit 4 název použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_LENGTH.BENEFIT_NAME + ' znaků',
    ...
    'priceVTInvalidFormat': 'Cena za VT použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_DIGIT_BEFORE_DECIMAL_POINT
        + ' desetinná místa a ' + CONSTS.VALIDATORS.MAX_DIGIT_AFTER_DECIMAL_POINT + ' celých čísel.',
    'priceNTInvalidFormat': 'Cena za NT použít můžete maximálně ' + CONSTS.VALIDATORS.MAX_DIGIT_BEFORE_DECIMAL_POINT
        + ' desetinná místa a ' + CONSTS.VALIDATORS.MAX_DIGIT_AFTER_DECIMAL_POINT + ' celých čísel.',
