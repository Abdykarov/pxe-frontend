...
export const importErrorViolations = {
    ...
    'deliveryLengthMustNotBeNull': 'Doba dodávky nesmí být prázdné',
    'deliveryToMustNotBeNull': 'Doba dodávky do data nesmí být prázdné',
    'deliveryFromMustNotBeNull': 'Doba dodávky od data nesmí být prázdné',
    'validToMustNotBeNull': 'Doba validity nabídky do data nesmí být prázdné',
    'validFromMustNotBeNull': 'Doba validity nabídky od data nesmí být prázdné',
    'supplierIdMustNotBeNull': 'ID dodavatele nesmí být prázdné',
    'nameMustNotBeBlank': 'Název nesmí být prázdné',
