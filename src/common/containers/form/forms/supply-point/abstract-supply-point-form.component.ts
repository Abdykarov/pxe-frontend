...
@Directive()
export class AbstractSupplyPointFormComponent
    ...
    implements OnInit, OnChanges
{
    ...
    public normalizationAnnualConsumption = (
    ...
    public detectChangesForAnnualConsumption = (
        ...
        const annualAnnualConsumption =
            this.form.controls[typeOfAnnualConsumption].value;
        if (annualConsumptionUnit === UNIT_OF_PRICES.KWH) {
            this.form.controls[typeOfAnnualConsumption].setValidators([
                withoutValidators
            ...
            const typeOfAnnualConsumptionValue = this.operationOnNumber(
                annualAnnualConsumption,
                (num) => num * 1000
            );
            this.form.controls[typeOfAnnualConsumption].setValue(
                typeOfAnnualConsumptionValue
            );
        } else {
            this.form.controls[typeOfAnnualConsumption].setValidators([
                withoutValidators
                ...
                CustomValidators.isNumber(
                    CONSTS.VALIDATORS
                        .MAX_DIGIT_AFTER_DECIMAL_POINT_ANNUAL_CONSUMPTION
                ),
                CustomValidators.minValue(0),
                CustomValidators.totalDigitLengthBeforeDecimalPoint(
