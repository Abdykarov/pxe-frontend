...
const orderByDeliveryTo = (supplyPoints: ISupplyPoint[]): ISupplyPoint[] =>  R.sortBy(R.prop('deliveryTo'))(supplyPoints);

export const concludedSupplyPointsToHistory = (currentYear: number) => (supplyPoints: ISupplyPoint[]): IHistory => R.pipe(
