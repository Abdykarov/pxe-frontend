...
export class ButtonComponent {
    ...
    constructor() {
        this.dotsDirection = R.contains(this.dotsDirection, Object.values(IDotsDirection)) ? this.dotsDirection : null;
        this.iconPosition = R.contains(this.iconPosition, Object.values(IIconPosition)) ? this.iconPosition : IIconPosition.LEFT;
        this.size = R.contains(this.size, Object.values(IButtonSize)) ? this.size : null;
        this.type = R.contains(this.type, Object.values(IButtonType)) ? this.type : null;
        this.variant = R.contains(this.variant, Object.values(IButtonVariant)) ? this.variant : null;
    }
}
